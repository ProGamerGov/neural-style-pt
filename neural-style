...
parser.add_argument("-model_file", help="Ex: path/to/model | 'vgg19-d01eb7cb.pth', 'vgg16-00b39a1b.pth', 'nin_imagenet.pth'", type=str, default='')
parser.add_argument("-disable_check", action='store_true')
parser.add_argument("-backend", choices=['nn', 'cudnn', 'mkl', 'openmp', 'mkldnn', 'mkl,cudnn', 'cudnn,mkl'], default='nn')
...
parser.add_argument("-download_models", help="Download the default VGG-19, VGG-16, and NIN models", nargs="?", type=str, const="none")
...
def main():
    ...
    if params.style_image == '':
        raise ValueError("You must select at least one style image or style image directory.")
